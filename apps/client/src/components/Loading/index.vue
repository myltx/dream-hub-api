<template>
  <div
    class="fixed flex w-screen h-screen justify-center items-center flex-col z-[99] overflow-hidden bg-white/50 dark:bg-slate-900 position-absolute top-0 left-0"
  >
    <div
